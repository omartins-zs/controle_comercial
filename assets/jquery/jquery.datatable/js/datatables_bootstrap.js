...
$.extend( true, $.fn.dataTable.defaults, {
	...
	"oLanguage": {
		...
		"sInfoFiltered": " - filtragem de _MAX_ registro",
		"sEmptyTable": "Não existem dados disponíveis",	
	}
} );
...
$.extend( $.fn.dataTableExt.oPagination, {
	"bootstrap": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			$(nPaging).append(
				'<ul class="pagination">'+
					'<li class="prev disabled"><a href="#" title="'+oLang.sPrevious+'"><i class="fa fa-angle-left"></i> Anterior</a></li>'+
					'<li class="next disabled"><a href="#" title="'+oLang.sNext+'">Próximo <i class="fa fa-angle-right"></i></a></li>'+
				'</ul>'
			);
